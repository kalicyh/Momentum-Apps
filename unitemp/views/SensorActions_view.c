...
void unitemp_SensorActions_alloc(void) {
    ...
    variable_item_list_add(variable_item_list, UNITEMP_UI_TEXT("Info", "信息"), 1, NULL, NULL);
    variable_item_list_add(variable_item_list, UNITEMP_UI_TEXT("Edit", "编辑"), 1, NULL, NULL);
    variable_item_list_add(variable_item_list, UNITEMP_UI_TEXT("Delete", "删除"), 1, NULL, NULL);

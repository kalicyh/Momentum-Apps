...
void unitemp_scene_sensor_menu_on_enter(void* context) {
    ...
    submenu_add_item(
        submenu, UNITEMP_UI_TEXT("Info", "信息"), SubmenuIndexInfo, unitemp_submenu_callback, app);
    submenu_add_item(
        submenu, UNITEMP_UI_TEXT("Edit", "编辑"), SubmenuIndexEdit, unitemp_submenu_callback, app);
    submenu_add_item(
        submenu, UNITEMP_UI_TEXT("Delete", "删除"), SubmenuIndexDelete, unitemp_submenu_callback, app);
    submenu_add_item(
        submenu,

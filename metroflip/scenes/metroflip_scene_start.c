...
void metroflip_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(
        submenu, METROFLIP_UI_TEXT("Scan Card", "扫描卡片"), MetroflipSceneAuto, metroflip_scene_start_submenu_callback, app);
    ...
    submenu_add_item(
        submenu, METROFLIP_UI_TEXT("Saved", "已保存"), MetroflipSceneLoad, metroflip_scene_start_submenu_callback, app);

    submenu_add_item(
        submenu,
        METROFLIP_UI_TEXT("Supported Cards", "支持的卡片"),
        MetroflipSceneSupported,
        metroflip_scene_start_submenu_callback,
        app);

    submenu_add_item(
        submenu, METROFLIP_UI_TEXT("About", "关于"), MetroflipSceneAbout, metroflip_scene_start_submenu_callback, app);

    submenu_add_item(
        submenu, METROFLIP_UI_TEXT("Credits", "致谢"), MetroflipSceneCredits, metroflip_scene_start_submenu_callback, app);

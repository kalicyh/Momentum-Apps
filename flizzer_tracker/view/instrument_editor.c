...
static const char* instrument_editor_params_description[] = {
    FLIZZER_TRACKER_UI_TEXT("CURRENT INSTRUMENT", "当前乐器"),
    FLIZZER_TRACKER_UI_TEXT("CURRENT INSTRUMENT NAME", "当前乐器名称"),
    FLIZZER_TRACKER_UI_TEXT("INSTRUMENT BASE NOTE", "乐器基准音"),
    FLIZZER_TRACKER_UI_TEXT("INSTRUMENT FINETUNE", "乐器微调"),
    FLIZZER_TRACKER_UI_TEXT("SLIDE SPEED", "滑音速度"),
    FLIZZER_TRACKER_UI_TEXT("SET PULSE WIDTH ON KEYDOWN", "按键时设置脉宽"),
    FLIZZER_TRACKER_UI_TEXT("PULSE WIDTH", "脉宽"),
    FLIZZER_TRACKER_UI_TEXT("SET FILTER PARAMETERS ON KEYDOWN", "按键时设置滤波器参数"),
    FLIZZER_TRACKER_UI_TEXT("NOISE WAVEFORM", "噪声波形"),
    FLIZZER_TRACKER_UI_TEXT("PULSE WAVEFORM", "脉冲波形"),
    FLIZZER_TRACKER_UI_TEXT("TRIANGLE WAVEFORM", "三角波形"),
    FLIZZER_TRACKER_UI_TEXT("SAWTOOTH WAVEFORM", "锯齿波形"),
    FLIZZER_TRACKER_UI_TEXT("METALLIC NOISE WAVEFORM", "金属噪声波形"),
    FLIZZER_TRACKER_UI_TEXT("SINE WAVEFORM", "正弦波形"),
    FLIZZER_TRACKER_UI_TEXT("ENVELOPE ATTACK", "包络起音"),
    FLIZZER_TRACKER_UI_TEXT("ENVELOPE DECAY", "包络衰减"),
    FLIZZER_TRACKER_UI_TEXT("ENVELOPE SUSTAIN", "包络持续"),
    FLIZZER_TRACKER_UI_TEXT("ENVELOPE RELEASE", "包络释放"),
    FLIZZER_TRACKER_UI_TEXT("ENVELOPE VOLUME", "包络音量"),
    FLIZZER_TRACKER_UI_TEXT("ENABLE FILTER", "启用滤波器"),
    FLIZZER_TRACKER_UI_TEXT("FILTER CUTOFF FREQUENCY", "滤波器截止频率"),
    FLIZZER_TRACKER_UI_TEXT("FILTER RESONANCE", "滤波器共振"),
    FLIZZER_TRACKER_UI_TEXT("FILTER TYPE (NONE=OFF)", "滤波器类型 (无=关)"),
    FLIZZER_TRACKER_UI_TEXT("ENABLE RING MODULATION", "启用环形调制"),
    FLIZZER_TRACKER_UI_TEXT("RINGMOD SOURCE CHANNEL (F=SELF)", "环形调制源通道 (F=自身)"),
    FLIZZER_TRACKER_UI_TEXT("ENABLE HARD SYNC", "启用硬同步"),
    FLIZZER_TRACKER_UI_TEXT("HARDSYNC SOURCE CHANNEL (F=SELF)", "硬同步源通道 (F=自身)"),
    FLIZZER_TRACKER_UI_TEXT("RETRIGGER INSTRUMENT ON SLIDE", "滑音时重触发乐器"),
    FLIZZER_TRACKER_UI_TEXT("SYNC OSCILLATORS ON KEYDOWN", "按键时同步振荡器"),
    FLIZZER_TRACKER_UI_TEXT("ENABLE VIBRATO", "启用颤音"),
    FLIZZER_TRACKER_UI_TEXT("VIBRATO SPEED", "颤音速度"),
    FLIZZER_TRACKER_UI_TEXT("VIBRATO DEPTH", "颤音深度"),
    FLIZZER_TRACKER_UI_TEXT("VIBRATO DELAY (IN TICKS)", "颤音延迟 (节拍数)"),
    FLIZZER_TRACKER_UI_TEXT("ENABLE PWM", "启用PWM"),
    FLIZZER_TRACKER_UI_TEXT("PWM SPEED", "PWM速度"),
    FLIZZER_TRACKER_UI_TEXT("PWM DEPTH", "PWM深度"),
    FLIZZER_TRACKER_UI_TEXT("PWM DELAY (IN TICKS)", "PWM延迟 (节拍数)"),
    FLIZZER_TRACKER_UI_TEXT("DON'T RESTART PROGRAM ON KEYDOWN", "按键时不重启程序"),
    FLIZZER_TRACKER_UI_TEXT("PROG.PERIOD (00 = PROGRAM OFF)", "程序周期 (00=程序关闭)"),
};
...
void draw_instrument_view(Canvas* canvas, FlizzerTrackerApp* tracker) {
    ...
    if(shift >= 12) {
        draw_inst_flag(
            ...
            EDIT_INSTRUMENT,
            INST_PROGRESTART,
            FLIZZER_TRACKER_UI_TEXT("NO PROG.RESTART", "不重启程序"),
            0,
            65 - shift,
            inst->flags,
            TE_PROG_NO_RESTART);

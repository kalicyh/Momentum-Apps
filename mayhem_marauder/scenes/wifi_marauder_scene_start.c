...
const WifiMarauderItem items[NUM_MENU_ITEMS] = {
    ...
    {WIFI_MARAUDER_UI_TEXT("Attack", "攻击"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Spoof Airtag", "仿造 Airtag"), {""}, 1, {"spoofat -t"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    ...
    {WIFI_MARAUDER_UI_TEXT("Load Evil Portal HTML file", "加载邪恶门户 HTML 文件"),
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Targeted Deauth", "定向解除认证"),
     {"station", "manual"},
     2,
    ...
    {WIFI_MARAUDER_UI_TEXT("Camera", "相机"),
     {"photo", "flashlight"},
     2,
     {"photo", "flashlight"},
     NO_ARGS,

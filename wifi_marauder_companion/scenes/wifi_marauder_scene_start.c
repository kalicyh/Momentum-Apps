...
const WifiMarauderItem items[NUM_MENU_ITEMS] = {
    {WIFI_MARAUDER_UI_TEXT("View Log from", "查看日志"), {"start", "end"}, 2, {"", ""}, NO_ARGS, FOCUS_CONSOLE_TOGGLE, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Scan", "扫描"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("SSID", "SSID"),
    ...
    {WIFI_MARAUDER_UI_TEXT("Select", "选择"),
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("AP Info", "AP 信息"),
     {""},
     1,
     {"info -a"},
     INPUT_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Set MAC", "设置 MAC"),
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Join WiFi", "连接 WiFi"),
     {"new", "saved"},
     2,
    ...
    {WIFI_MARAUDER_UI_TEXT("Clear List", "清除列表"),
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Attack", "攻击"),
     {"deauth",
      "probe",
      "rickroll",
      "funny",
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Spoof Airtag", "仿造 Airtag"),
     {""},
     1,
     {"spoofat -t"},
     INPUT_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Wardrive", "路演扫描"),
     {"ap", "station", "flock", "bt"},
     4,
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Evil Portal", "邪恶门户"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Load Evil Portal HTML file", "加载邪恶门户 HTML 文件"),
     {""},
     1,
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Targeted Attacks", "定向攻击"),
     {"deauth",
      "manual",
      "karma",
      "badmsg",
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Beacon Spam", "Beacon 垃圾消息"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Port Scan", "端口扫描"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Sniff", "嗅探"),
     ...
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Signal Monitor", "信号监控"), {""}, 1, {"sigmon"}, NO_ARGS, FOCUS_CONSOLE_END, SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Channel", "信道"),
     {"get", "set"},
     2,
     {"channel", "channel -s"},
     TOGGLE_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("LED", "LED"), {"hex", "pattern"}, 2, {"led -s", "led -p"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("GPS Data", "GPS 数据"),
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("GPS POI", "GPS 兴趣点"),
     {"start", "mark", "end"},
     3,
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Settings", "设置"),
     ...
     FOCUS_CONSOLE_START,
     NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Shutdown WiFi", "关闭 WiFi"), {""}, 1, {"stopscan -f"}, NO_ARGS, FOCUS_CONSOLE_START, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("List SD", "SD 卡列表"), {""}, 1, {"ls /"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Update", "更新"), {"sd"}, 1, {"update -s"}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Reboot", "重启"), {""}, 1, {"reboot"}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Help", "帮助"), {""}, 1, {"help"}, NO_ARGS, FOCUS_CONSOLE_START, SHOW_STOPSCAN_TIP},
    {WIFI_MARAUDER_UI_TEXT("Info", "信息"), {""}, 1, {"info"}, NO_ARGS, FOCUS_CONSOLE_START, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Scripts", "脚本"), {""}, 1, {""}, NO_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {WIFI_MARAUDER_UI_TEXT("Save to flipper sdcard", "保存到 Flipper SD 卡"), // keep as last entry or change logic in callback below
     {""},
     1,
     {""},
     NO_ARGS,

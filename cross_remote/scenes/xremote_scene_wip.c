...
void xremote_scene_wip_on_enter(void* context) {
    ...
    popup_set_header(popup, XREMOTE_UI_TEXT("SubGhz coming soon", "SubGhz 即将上线"), 10, 19, AlignLeft, AlignBottom);
    popup_set_text(popup, XREMOTE_UI_TEXT("Check back later", "请稍后检查"), 10, 29, AlignLeft, AlignBottom);
    popup_set_text(popup, XREMOTE_UI_TEXT("Press back long", "长按返回"), 10, 39, AlignLeft, AlignBottom);

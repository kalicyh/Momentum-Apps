...
char* setting_replay_names[] = {ROLLING_FLAWS_UI_TEXT("No", "否"), ROLLING_FLAWS_UI_TEXT("Yes", "是")};
...
char* setting_sn_zero_names[] = {ROLLING_FLAWS_UI_TEXT("No", "否"), ROLLING_FLAWS_UI_TEXT("Yes", "是")};
...
char* setting_count_zero_names[] = {ROLLING_FLAWS_UI_TEXT("No", "否"), ROLLING_FLAWS_UI_TEXT("Yes", "是")};
...
void rolling_flaw_populate_variable_item_list(RollingFlaws* app) {
    ...
    item = variable_item_list_add(
        ...
        ROLLING_FLAWS_UI_TEXT("Frequency", "频率"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Protocol", "协议"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Fix [Btn+SN]", "固定码 [按钮+序列号]"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Replay attack", "重放攻击"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Window [next]", "窗口 [下一个]"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Window [future]", "窗口 [未来]"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Window [gap]", "窗口 [间隔]"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("SN00/cfw*", "SN00/自定义*"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("SN bits/cfw*", "SN 位数/自定义*"),
    ...
    item = variable_item_list_add(
        app->variable_item_list_config,
        ROLLING_FLAWS_UI_TEXT("Count 0 opens", "计数 0 视为开启"),

...
#define APP_NAME I2CTOOLS_UI_TEXT("I2C Tools", "I2C 工具")

#include <assets_icons.h>

#define SCAN_MENU_TEXT I2CTOOLS_UI_TEXT("Scan", "扫描")
#define SCAN_MENU_X    90
#define SCAN_MENU_Y    7

#define SNIFF_MENU_TEXT I2CTOOLS_UI_TEXT("Sniff", "嗅探")
#define SNIFF_MENU_X    90
#define SNIFF_MENU_Y    21

#define SEND_MENU_TEXT I2CTOOLS_UI_TEXT("Send", "发送")
#define SEND_MENU_X    90
#define SEND_MENU_Y    35

#define INFOS_MENU_TEXT I2CTOOLS_UI_TEXT("Infos", "信息")

...
void mfc_editor_scene_invalid_file_on_enter(void* context) {
    ...
    popup_set_header(popup, MFC_EDITOR_UI_TEXT("Invalid file", "无效文件"), 63, 10, AlignCenter, AlignTop);
    popup_set_text(
        popup, MFC_EDITOR_UI_TEXT("Only MIFARE Classic files\nare supported", "仅支持 MIFARE Classic 文件"), 63, 40, AlignCenter, AlignCenter);
